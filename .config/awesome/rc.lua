...
myexitmenu = {
    ...
    { "switch user", "dm-tool switch-to-greeter", menubar.utils.lookup_icon("system-log-out") },
...
--SCREENSHOTS
    ...
    awful.key({  }, "XF86HomePage", function () awful.spawn.with_shell("terraria") end,
              {description = "launch Terraria", group = "launcher"}),
    ...
    awful.key({ altkey }, "space", function ()
            os.execute(string.format("dmenu_run -i -fn 'Roboto Mono:12' -nb '%s' -nf '%s' -sb '%s' -sf '%s'",
